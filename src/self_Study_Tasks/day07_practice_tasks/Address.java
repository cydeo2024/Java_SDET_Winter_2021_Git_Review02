...
public class Address {
   ...
   public String toString() {
      return "day07_practice_tasks.Address: " +
                buildingNumber + " " +
               street + " " +
                city + " " +
               state + " , " +
...
/*
 Create a custom class named day07_practice_tasks.Address with the following attributes and actions:
      ...
      Create another class named day07_practice_tasks.AddressClients, create multiple address objects, and test each function of the address object.
